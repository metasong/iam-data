...
186| 131| 5
181| 95 |  6
> the download speed (200M) is better than Re700x which is around 120M, but the upload speed(125M) is worse than it(150M) , the latency is a bit good 6ms versus 6.5ms, but when testing in Yiqi's room, the download speed degrade to 179M and upload speed is 
