...
not all flyweight subclasses need to be shared. the flyweight interface enables sharing; it doesn't enforce it.(rows and columns in article has shared flyweight children, but they are not shared)
