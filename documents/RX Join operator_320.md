...
var cmd = Observable.Interval(TimeSpan.FromMilliseconds(100)).Select(id=>new  {Id = id, Des="cmd" + id});
var cmdStatus = Observable.Interval(TimeSpan.FromMilliseconds(500)).Select(id=>new {Id = id, Des="cmdstatus"+id});
