...
```
Why IIFE?
it create us an additional scope for the code within it. Any veriables or functions within a scope are only visible to the code within the scope. if the code in the scope return a function/object to the outside of the scope, the functionor functions defined in the scope of the obj still has accessbility to those variables/functions.
