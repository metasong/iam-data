...
* angular's ui is orgnized by template, it's a 3D structure, the component's element in the template, can expand into another template. on the top is the app
