...
```html {2, 3}
<host> <!-- 0: host element's component change detection -->
  <comp> <!--1: element's component changes detection--> <!-- 3: component template -->
    <content1></content1> <!-- 2: content -->
    <content2></content2>
  </comp>
  <comp1></comp1> <!-- 4: sibling element --> <!-- 5: sibling element component-template -->
</host>
```
