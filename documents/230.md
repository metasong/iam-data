...
```html {2, 3}
<!-- 0: host element's component change detection --> <!--6: components/directives inside host's templete -->
  <comp> <!--1: element's component changes detection, the first content child of host--> <!-- 3: components/directives inside component template -->
