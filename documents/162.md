...
## 1112
* interview
* discusstion with Mathieu about simulator testing
* Fuse trigger for Profibus V1
* answer email about profibus plugin testing with NOV. and quick discussion with Dimitriy about simulator problem.
## 1113
* kick off US with Mik, publish UI
* pr for add/close publish for MK to use
* email to NOV about pribus testing with simulator.
* PR review for Mathieu
## 1114
*   questions:
    * the skipass 963 from 6days: https://skipass.valmorel.com/fr/liste-resultats?vc=6&ctid=240&station=Valmorel&date=2025-12-21&CHILD=2&ADULT=2
    * 
