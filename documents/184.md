...
```S
const a:mustInitiallizedWithCompileTimeConstExpression // implicitly imutable, static lifetime
...
// decision: allow global variable?
// search in Claude: why rust do not allow declear global variable
