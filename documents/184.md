...
## Primitive Types
```S
i8 i16 i32 i64 isz // isize pointer-sized signed integer
...
//error: user want to creat a new variable of same name in same scope
a:6 //error override the  declearation with a new declearation of the same name
{
    a:7 // new overriding previous declearation in the block scope, new a
}
