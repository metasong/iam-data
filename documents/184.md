...
// : is ofPattern operator, used to further contrain the pattern, we use = do pattern maching
a:1i32 // a is follow the patter of value 1i32, means it can only be 1i32, it's type is 1i32
aa:i32 = 1 
// pattern match explaining
variable pattern, then type pattern
