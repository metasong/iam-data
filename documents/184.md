...
```S
// old design
// `Color = [@Key(0xFF0000)]Red|[@Key(0x00FF00)]Green|[@Key(0x0000FF)]Blue

// new design
//this is more better, with const type
...
## Summery of Types
we have predefined primitive types, by combining(producting) we create struct, tupple; by aggregation, we create Array, List, Set, and Map; by sum
