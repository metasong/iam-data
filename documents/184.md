...
: is the bind operator, to bind value and/or type, after bind the type can not be changed, but the value can be changed if it's a mutable variable (start with Captial letter)
