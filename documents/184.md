...
aa:i32 = 1 
// let: declearation 
// a = 1 // = (mut operator) can be used for init (first mut). allow this?
...
```S
[(
A(m:_): 3 // paramter name m oftype A
(n:_): 4 // paramter name n of any type
A(2:_): 7 // paramter of index 2 of type A
A.b.c:_: 8 // type A with property b that has proterty c
)]
```
