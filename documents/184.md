...
i.e. the null reference error: the program does not handle the return the null value, which is not the happy pass, and treat the null as the same way of a valid object handling. to saving: explicitly mark
