...
## Type
```
Type: type Name[([memberName':'][memberType][=defaultValueLiteral]@1[,...1])] 
...
```
DiscriminatedUnions: type TypeName = SubTypeSymbol[...]
SubTypeSymbol: SubTypeName|Type
[...]: optional repeat

Type is defined in scope.
for a sybTypeSymbol: if not defined, it's a subtype name and we create a subtype
```
