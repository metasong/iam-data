...
ref type is on heap, value type corresponding the memlocation, it's inline type, can be on heap(i.e. as a mem of a ref type) or stack
```S
...
// a List var c on stack with mem of 500 i32 on heap {500*i32;refCnt:i32}
