...
### constructor
```S
type A(readOnly: i32, Mutable: Str, _private: i32, _PrivateMutable: [i32]) {
 _private: i32
...
d: Array<i32>()
b: [1i32, 2, 3] 
// [] is content initializer
// can avoid realocation if we already know the max capacity
type Array<T>(init:T = cap: i32,default(T),  len: i32, data: *T)
c: [i32](5)
