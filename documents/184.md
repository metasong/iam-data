...
// forward error: valid value become expression result but current function result: include error
func()??
// forward or throw: forward valid value (incude T or None) but throw on Err
func()?!

// handle all
func()#{ v:T?{}, None?{}, err:Error?{} }  // #{}: must handle all cases
// forward unhandled, and handle case in pattern match clause
func()?#{ None?{}, err:Error?{} }?? // forward T 
