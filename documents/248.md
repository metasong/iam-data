...
* activly involved in task and hard-bone problem that related to several teams, i.e. Akita 802: AutoROP unresponsive problem(1658124, 1643706); CG fails to reconnect/communicate on OPC-UA driver(1666524); make Symphony UnitAbstract lib to dotnet standard(1681446); ...
* RigGateway Service: implement Time Series Data(1668818); fix duplicate OPCUA connection when change drivers; RigGateway is configurable via the Automation Config page(1702051); Health Monitor page displays RigGateway Health(1702053)...
