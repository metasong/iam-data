...
## team work highlight
* fix critical bug on ControlGateway Iraq setup: OPCUA server status unknow problem(CG disconnected when KeepAlive message can not send out), which is thread scheduling problem within CG and thirdparty OPCUADriver.  [summary](https://slb1-swt.visualstudio.com/Planck/_sprints/taskboard/Presto/Planck/Presto/Iteration%2077?workitem=1645589)
* 
## knowledge share
