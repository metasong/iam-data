...
* investigate and implement the way to migrate the automation UI's Form module to Angular Form package, show and review within team, although not used but layout foundation for futrue work, and serve as a way to migrate to Angular From if Core team also determined to use 
## knowledge share
